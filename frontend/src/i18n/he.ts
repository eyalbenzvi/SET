...
export const he = {
  ...
  'game.hint1': 'רמז 1',
  'game.hint2': 'רמז 2',
  // `{clock}` הוא ספירה לאחור עד שהרמז נפתח: "רמז 2 · 42".
  ...
  'tutorial.flowClaim':
    'הקישו על שלושה קלפים ואז על «מצאתי SET». נכון — נקודה לזכותכם. לא נכון — אתם בלבד מושהים ל-2 שניות, וכל השאר ממשיכים לשחק.',
  'tutorial.flowRefill':
